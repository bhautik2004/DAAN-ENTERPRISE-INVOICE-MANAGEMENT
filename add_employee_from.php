        ...
        <form action="" method="POST">
            <div class="grid grid-cols-1 gap-4">
                <div>
                    ...
                    <input type="text" name="employee_name" class="w-full p-2 mt-1 border border-gray-300 rounded-md"
                        required>
                </div>
                <div>
                    <label class="block text-sm font-semibold">Username</label>
                    <input type="text" name="username" class="w-full p-2 mt-1 border border-gray-300 rounded-md"
                        required>
                </div>
                <div>
                    <label class="block text-sm font-semibold">Password</label>
                    <input type="password" name="password" class="w-full p-2 mt-1 border border-gray-300 rounded-md"
                        required>
                </div>
                <div>
                    <label class="block text-sm font-semibold">Mobile No</label>
                    <input type="text" name="mobile_no" class="w-full p-2 mt-1 border border-gray-300 rounded-md"
                        required>
                </div>
            </div>
