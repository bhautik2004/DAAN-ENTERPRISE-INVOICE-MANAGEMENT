    ...
    <main class="flex-1 pl-56 m-4">
        ...
        <div class="bg-white p-4 rounded-md shadow-md mt-4">
            ...
            <form method="GET" class="mb-4 flex flex-wrap items-center gap-4">
                ...
                <a href="export_monthemp.php?filter_month=<?php echo $selected_month; ?>&filter_year=<?php echo $selected_year; ?>"
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div class="p-3 bg-white rounded shadow">
                        ...
                        <p class="text-sm text-gray-500"><?php echo $returned_orders; ?> orders
                            (<?php echo $total_orders > 0 ? round(($returned_orders / $total_orders) * 100, 1) : 0; ?>%)
                        </p>
                    </div>
                </div>
            </div>
                ...
                <tbody>
                    ...
                    <tr class="text-left bg-gray-50 hover:bg-gray-100">
                        ...
                        <td class="p-2 border text-green-600 font-bold">₹
                            <?php echo number_format($row['total_monthly_revenue'], 2); ?></td>
                    ...
                    <tr>
                        <td class="p-2 border text-center text-gray-500" colspan="10">No data found for selected month.
                        </td>
                    </tr>
                    <?php endif; ?>
                </tbody>
