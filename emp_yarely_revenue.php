...
<div class="bg-white p-4 rounded-md shadow-md mt-4">
    ...
    <form method="GET" class="mb-4 flex flex-wrap items-center gap-4">
        ...
        <a href="export_yearemp.php" class="bg-yellow-500 text-white px-4 py-2 rounded-md hover:bg-yellow-600">
            Export to Excel
        </a>
    </form>
        ...
        <tbody>
            ...
            if ($emp_yearly_result->num_rows > 0):
                ...
                <tr class="text-left bg-gray-50 hover:bg-gray-100">
                    ...
                    <td class="p-2 border text-green-600 font-bold">₹ <?php echo number_format($row['total_yearly_revenue'], 2); ?></td>
                ...
                <tr>
                    <td class="p-2 border text-center text-gray-500" colspan="8">No data found for selected year.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
